 ...
 * Projector is dark-only (no light theme toggle).
 */
...
export const pdGlass = {
  ...
  glassPanel: `linear-gradient(145deg, rgba(${violetRgb}, 0.22) 0%, rgba(${violetRgb}, 0.08) 42%, rgba(10, 10, 20, 0.72) 100%)`,
  glassPanelStrong: `linear-gradient(165deg, rgba(${violetRgb}, 0.32) 0%, rgba(${violetRgb}, 0.12) 40%, rgba(10, 10, 20, 0.72) 100%)`,
  borderViolet: `rgba(${violetRgb}, 0.55)`,
  borderMint: `rgba(${mintRgb}, 0.65)`,
  borderMintStrong: `rgba(${mintRgb}, 0.85)`,
  glowViolet: `0 0 40px rgba(${violetRgb}, 0.35)`,
  glowMint: `0 0 36px rgba(${mintRgb}, 0.3)`,
  shadowGlass: `0 12px 40px rgba(0, 0, 0, 0.18), inset 0 0 0 1px rgba(${mintRgb}, 0.12)`,
